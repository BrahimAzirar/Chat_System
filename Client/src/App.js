  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/account/:userId/Friends"
          element={
            <Provider store={store}>
              <Account content={<AddFriends />} />
            </Provider>
          }
        />
        <Route
          path="/account/:userId/FriendsRequests"
          element={
            <Provider store={store}>
              <Account content={<FriendsRequests />} />
            </Provider>
          }
        />
        <Route
          path="/account/:userId/UpdateData"
          element={
            <Provider store={store}>
              <Account content={<UpdateData />} />
            </Provider>
          }
        />
      </Routes>
